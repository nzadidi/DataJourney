...
\CommentTok{\#Use \textless{}{-} to assign a value to a variable}
\NormalTok{x }\OtherTok{\textless{}{-}} \DecValTok{5}
\NormalTok{y }\OtherTok{\textless{}{-}} \StringTok{"Hello, world!"}
\NormalTok{z }\OtherTok{\textless{}{-}} \ConstantTok{TRUE}

\CommentTok{\# Checking data types}
\FunctionTok{class}\NormalTok{(x)    }\CommentTok{\# Numeric}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(z)    }\CommentTok{\# Logical}
\end{Highlighting}
\end{Shaded}
